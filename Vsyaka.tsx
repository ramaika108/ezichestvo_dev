...
import PoetryModal from "../components/modals/PoetryModal";
...
const Vsyaka = () => {
	...
	<div className="container">
        ...
        {showSecret && <h4 className="vsyaka-item__title" data-micromodal-open="modal-society">Тайное общество</h4>}
					...
					<div className="col-lg-4 col-sm-6 vsyaka-item">
                        <img src={bloh1} alt="Поэта может обидеть каждый..." />
						<h4 className="vsyaka-item__title" data-micromodal-open="modal-poem">Поэзия, и немного прозы жизни</h4>
					</div>

				</div>
                <Pagination extraClass="vsyaka__pagination" />
                <ModalWrapper>
                    <HumorPumpModal />
                    <HoroscopeModal />
                    <TSocietyModal />
